        ...
        <div className="relative min-h-0 sm:min-h-[calc(90vh-180px)] overflow-hidden sm:overflow-visible modal-content-wrapper">
          ...
          >
            <div
              ...
              className="p-6 pb-14 space-y-6 max-h-[calc(85vh-120px)] overflow-y-auto sm:max-h-[calc(90vh-180px)] animate-fade-in"
            >
              <ProjectDetailView
          ...
          >
            <div className="p-6 pb-14 space-y-6 max-h-[calc(85vh-120px)] overflow-y-auto sm:max-h-[calc(90vh-180px)]">
              <ProjectEditForm
                project={viewingProject}
