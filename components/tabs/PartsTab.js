        ...
        <div className="stats-container-800">
          ...
          <div className="stats-cards-800">
              ...
              >
                ...
                <div key={statusFilter === 'pending' ? 'pending' : statusFilter === 'purchased' ? 'purchased' : 'ordered'} className={(statusFilter === 'pending' || statusFilter === 'purchased') ? 'status-card-content' : ''}>
